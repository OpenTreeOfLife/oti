 ...
 * 
 */
public class index extends ServerPlugin {
	...
	public Representation add_nexsons(@Source GraphDatabaseService graphDb,
...
//				}
	...
	@PluginTarget(GraphDatabaseService.class)
	public Representation remove_nexsons(@Source GraphDatabaseService graphDb,
